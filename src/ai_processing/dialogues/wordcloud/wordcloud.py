...
# Modified by: Abdelhak Loukkal <abdelhak.loukkal@imaginario.ai>
#
# License: MIT
...
FONT_PATH = os.environ.get('FONT_PATH', os.path.join(FILE, 'Poppins-Regular.ttf'))
...
class colormap_color_func(object):
    ...
    def __call__(self, word, font_size, position, orientation,
        ...
        if random_state is None:
            random_state = Random()
        r, g, b, _ = np.maximum(0, 255 * np.array(self.colormap(max(0.,
            random_state-0.2))))
...
class WordCloud(object):
    ...
    def __init__(self, font_path=None, width=600, height=400, margin=2,
    ...
    def generate_from_frequencies(self, frequencies, max_font_size=None):
        ...
        frequencies = [(word, freq/max_freq) for word, freq in frequencies]
    ...
    def to_svg(self, embed_font=False, optimize_embedded_font=True, embed_image=False):
        ...
        due to dependento_filees, this feature is not always enabled. Hence, the
